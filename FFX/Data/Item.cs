...
namespace Farplane.FFX.Data
{
    public class Item
    {
        ...
        private static readonly int _offsetItemTypes = OffsetScanner.GetOffset(GameOffset.FFX_ItemTypes);
        private static readonly int _offsetItemCounts = OffsetScanner.GetOffset(GameOffset.FFX_ItemCounts);
        ...
        {
            GameMemory.Write(_offsetItemTypes + itemSlot*2, (ushort)itemId, false);
            GameMemory.Write(_offsetItemCounts + itemSlot, itemCount, false);
        }
